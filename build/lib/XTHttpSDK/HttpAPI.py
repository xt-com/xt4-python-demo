...
class SignedHttpAPI:
    ...
    def get_order(self, data: dict):
        ...
        headers, data = get_auth_payload(_data, XT4PlatConfig.GET_ORDER)
        return request("GET", XT4PlatConfig.GET_ORDER, json=data, headers=headers)
    ...
    def get_order_list(self):
        ...
        headers, _ = get_auth_payload(_data, XT4PlatConfig.GET_ORDER)
        return request("GET", XT4PlatConfig.GET_ORDER, headers=headers)
    ...
    def get_batch_order(self, data: dict):
        ...
        _data = self.get_datas(data)
        _data["urlencoded"] = True
        headers, data = get_auth_payload(_data, XT4PlatConfig.GET_BATCH_ORDERS)

        return request("GET", XT4PlatConfig.GET_BATCH_ORDERS, params=data, headers=headers)
    ...
    def send_batch_order(self, data: dict):
        ...
        """
        _data = self.get_datas(data)
        headers, data = get_auth_payload(_data, XT4PlatConfig.BATCH_ORDER)
        return request("POST", XT4PlatConfig.BATCH_ORDER, json=data, headers=headers)
    ...
    def batch_cancel_order(self, data: dict):
        ...
        headers, data = get_auth_payload(
            _data, XT4PlatConfig.DELETE_OPEN_ORDERS)
        return request("DELETE", XT4PlatConfig.DELETE_OPEN_ORDERS, json=data, headers=headers)
    ...
    def get_open_order(self, data: dict):
        ...
        _data = self.get_datas(data)
        _data["urlencoded"] = True
        headers, data = get_auth_payload(_data, XT4PlatConfig.GET_OPEN_ORDERS)

        return request("GET", XT4PlatConfig.GET_OPEN_ORDERS, params=data, headers=headers)
    ...
    def get_balance(self, data: dict):
        ...
        _data = self.get_datas(data)
        _data["urlencoded"] = True
        headers, data = get_auth_payload(_data, XT4PlatConfig.GET_BALANCE)

        return request("GET", XT4PlatConfig.GET_BALANCE, params=data, headers=headers)
    ...
    def get_funds(self, data: dict):
        ...
        _data = self.get_datas(data)
        _data["urlencoded"] = True
        headers, data = get_auth_payload(_data, XT4PlatConfig.GET_FUNDS)

        return request("GET", XT4PlatConfig.GET_FUNDS, params=data, headers=headers)
